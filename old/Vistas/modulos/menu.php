    ...
    <div class="row">
        ...
        <div class="col-lg-6 align py-3">
            <ul>
                ...
                <li>Series</li>
                <li>
                    <a href="Perfil" class="line">Mi Perfil</a>
             ...
             <?php
                    ...
                    $usuario = UsuariosC::VerUsuariosC($columna, $valor);
                        ...
                        if($usuario["foto"] != ""){
                            ...
                            echo '<img src="'.$generales["ruta"].''.$usuario["foto"].'" id="user">';

                        }else{

                            echo '<img src="'.$generales["ruta"].'Vistas/img/user.png" id="user">';
    ...
    <div class="es">
        ...
        <!-- <div class="single-not recomendacion">
            ...
            <!-- <div class="notification" id="noti" style="display:none;">
                ...
                <div class="es">
                    <p class="setitle">Esta semana.</p>
                    <div class="single-not solicitud">
                        <div class="row">
                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-5">
                                <h5>Richard White</h5>
                                <p>Te ha invitado a ver una película juntos</p>
                            </div>
                            <div class="col-lg-5">
                                <div class="row">
                                    <div class="col-lg-6">
                    ...
                    <div class="single-not recomendacion">
                        <div class="row">
                            <div class="col-lg-2">
                                <img src="<?php echo $generales["ruta"]; ?>Vistas/img/images/smiley.png">
                            </div>
                            <div class="col-lg-5">
                                <h5>Julia Roberts</h5>
                                <p>Te recomendó "Shrek"</p>
                            ...
                            <div class="col-lg-5 last">
                                <img src="<?php echo $generales["ruta"]; ?>Vistas/img/images/spiderman.png">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="es">
                    <p class="setitle">Semana Pasada.</p>
                    <div class="single-not solicitud">
                        <div class="row">
                            <div class="col-lg-2">
                                <img src="<?php echo $generales["ruta"]; ?>Vistas/img/images/profile.png">
                    ...
                    <div class="single-not recomendacion">
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <h5>Harry Ferguson</h5>
                                <p>Te recomendó "Que paso ayer"</p>
                            </div>
                            <div class="col-lg-5 last">
                                <img src="<?php echo $generales["ruta"]; ?>Vistas/img/images/qpa.png">
                            </div>
                        </div>
                    </div>
                </div>
