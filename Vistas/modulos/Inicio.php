                ...
                <iframe width="727" height="409" src="https://www.youtube.com/embed/GDWauwXOoik" title="Marvel Studios’ Black Panther: Wakanda Forever | Official Teaser" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <p class="text-white social-title">
                                <b>'.$user["nombre"].'</b> vio y calificó con

                            </p>
                            <p class="cn font-weight-bold social-title">'.$result["title"].'</p>
                        </div>
                    ...
                    <div class="row px-4">
                        <div class="col-5 buttons">
                            <div class="row">
                                <div class="col-4">
                                    <img src="'.$urlP.'Vistas/img/images/like.png">
                                </div>
                                <div class="col-4">
                                    <img src="'.$urlP.'Vistas/img/images/comentar.png">
                                </div>
                                <div class="col-4">
                                    <img src="'.$urlP.'Vistas/img/images/mas.png">
                                </div>
                            </div>
                        </div>
                        <div class="col-6 text-right buttons">
                            <img src="'.$urlP.'Vistas/img/images/visto.png">
                        </div>
                    </div>
                    <div class="row px-5">
